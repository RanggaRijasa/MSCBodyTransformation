...
on conflict (user_id) do update set
  ...
  coach_is_public = excluded.coach_is_public,
...
values
  ('0a000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', 'Coach Satu', '+628000000002', 'sc', true, true, 'test-v1', 'active', 'grant-coach-one', now(), now(), '00000000-0000-0000-0000-000000000001'),
  ('0a000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003', 'Coach Dua', '+628000000003', 'sc', true, true, 'test-v1', 'active', 'grant-coach-two', now(), now(), '00000000-0000-0000-0000-000000000001');
