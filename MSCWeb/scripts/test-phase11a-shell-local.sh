...
phase11a_temp_dir="$(mktemp -d "${TMPDIR:-/tmp}/mscweb-phase11a-shell.XXXXXX")"
...
AUTH_FLOW_COOKIE_SECRET="phase11a-shell-local-cookie-secret-2026-only" \
APP_ENVIRONMENT="phase11a-shell-local" \
