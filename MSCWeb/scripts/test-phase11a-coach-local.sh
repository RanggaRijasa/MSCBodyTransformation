...
temp_dir="$(mktemp -d "${TMPDIR:-/tmp}/mscweb-phase11a-coach.XXXXXX")"
...
AUTH_FLOW_COOKIE_SECRET="phase11a-coach-local-cookie-secret-2026-only" \
APP_ENVIRONMENT="phase11a-coach-local" \
  "$web_root/node_modules/.bin/playwright" test \
    tests/e2e/phase11a-coach-visual.spec.ts \
