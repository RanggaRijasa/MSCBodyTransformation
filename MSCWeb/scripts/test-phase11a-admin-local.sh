...
phase11a_temp_dir="$(mktemp -d "$web_root/.phase11a-admin.XXXXXX")"
...
DB_URL="$DB_URL" \
AUTH_FLOW_COOKIE_SECRET="phase11a-admin-local-cookie-secret-2026-only" \
APP_ENVIRONMENT="phase11a-admin-local" \
  node_modules/.bin/playwright test \
    tests/e2e/phase11a-admin-visual.spec.ts \
