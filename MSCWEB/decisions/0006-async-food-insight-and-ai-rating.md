...
OpenRouter dengan model vision Gemma menjadi provider awal. Produk menginginkan pergantian provider semudah mungkin dan tidak menginginkan baseline consent/DPIA/ZDR/withdrawal flow yang berat untuk foto makanan.
...
- Insight dan alasan rating wajib dalam Bahasa Indonesia. Prompt/schema meminta Bahasa Indonesia; output non-Indonesia tidak diteruskan mentah dan diganti melalui retry terbatas atau fallback Indonesia tervalidasi.
